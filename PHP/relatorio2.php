...
$sql = " SELECT * FROM relatorio2 WHERE data_hora LIKE '%" . $dataPesquisa .  "%' "; 
}else{
...
$sql = " SELECT * FROM relatorio2 WHERE data_hora LIKE '%" . $nulo .  "%' "; 
}
...
echo "<tr> <th>Luz</th> <th>Estado Luz</th>  <th>Data/Hora</th>  </tr>";
...
echo"<tr>";
echo"<td>" . $linha->luz ."</td>";
echo"<td>" . $linha->est_luz2   ."</td>";
